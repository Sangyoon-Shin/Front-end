...
import styles from "./InformationCodeBoard.module.css";
  ...
  return (
    <div>
      ...
      <div className={styles["content"]}>
        ...
        <h1 className={styles["title-text2"]}>코드 질문 게시판</h1>
...
export default InformationCodeBoard;
